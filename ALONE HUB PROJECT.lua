...
local Save = function()
	...
	if syn then
		makefolder("Uwushop scripts/ID/"..game.GameId)
	else
		makefolder("Uwushop scripts")
		makefolder("Uwushop scripts/ID")
		makefolder("Uwushop scripts/ID/"..game.GameId)
	end
	writefile("Uwushop scripts/ID/"..game.GameId.."/"..game.Players.LocalPlayer.Name..".lua", game:GetService("HttpService"):JSONEncode(SettingsGameData));
end
		...
		while wait() do
			if AutoObservation then
				if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
					local ahasd = Notification.new("success", " UwU shop", "Observation Range : Max") 
...
local AncientQuest = Tabs.V4Race:AddToggle("AutoAncientQuest", {Title = "Auto Ancient Quest", Default = AutoAncientQuest })
local RaceTrial = Tabs.V4Race:AddToggle("AutoRaceTrial", {Title = "Auto Race Trial", Default = AutoRaceTrial })
